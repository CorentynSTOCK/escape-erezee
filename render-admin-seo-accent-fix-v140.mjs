...
async function buildSeoDashboardV138() {
  const checks = await Promise.all([
    ...
    publicCheckV138('Activite famille Ardenne', 'activite-famille-ardenne.html', ['Activité famille']),
    publicCheckV138('Chasse au tresor Ardenne', 'chasse-au-tresor-ardenne.html', ['Chasse']),
    publicCheckV138('Activite touristique Erezee', 'activite-touristique-erezee.html', ['Érezée']),
...
console.log(`Admin SEO accent fix v${VERSION} applied.`);
